...
public class RatingDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mRatingBar = v.findViewById(R.id.recipe_form_rating);
        mRatingText = v.findViewById(R.id.recipe_form_text);

        v.findViewById(R.id.recipe_form_button).setOnClickListener(this);
        v.findViewById(R.id.recipe_form_cancel).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.recipe_form_button:
                onSubmitClicked(v);
                break;
            case R.id.recipe_form_cancel:
                onCancelClicked(v);
                break;
        }
    }
